...
public class RootResource extends LwM2mClientCoapResource {
    ...
    public void handleFETCH(CoapExchange exchange) {
        ...
        if (response.getCode().isError()) {
            ...
            exchange.respond(toCoapResponseCode(response.getCode()),
                    encoder.encode(response.getContent(), responseContentFormat, rootEnabler.getModel()),
    ...
    public void handleIPATCH(CoapExchange exchange) {
        ...
        Map<LwM2mPath, LwM2mNode> nodes = decoder.decode(coapRequest.getPayload(), contentFormat,
                (List<LwM2mPath>) null, rootEnabler.getModel());
