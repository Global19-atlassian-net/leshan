...
public class DefaultLwM2mNodeDecoder implements LwM2mNodeDecoder {
    ...
    @Override
    public Map<LwM2mPath, LwM2mNode> decode(byte[] content, ContentFormat format, List<LwM2mPath> paths,
        ...
        if (decoder instanceof MultiNodeDecoder) {
            return ((MultiNodeDecoder) decoder).decode(content, paths, model);
        } else {
